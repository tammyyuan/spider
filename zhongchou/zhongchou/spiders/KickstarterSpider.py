...
class KickstarterSpider(CrawlSpider):
    ...
    def parse_list(self, response):
        ...
        if len(grid_row) > 0:
            for grid in grid_row:
                if len(
                        grid.xpath('./div[@class="col-full col-sm-12-24 col-lg-8-24"]')) > 0:
                    for detail in grid.xpath(
                            './div[@class="col-full col-sm-12-24 col-lg-8-24"]'):
                        data_project = detail.xpath(
                            './div/@data-project').extract()[0]
                        ...
                        if isinstance(data_project, dict):
    ...
    def parse_error(self, failure):
        ...
        with open('kick_Traceback.txt', 'a') as f:
            f.write(url + '\n')
    ...
    def parse_detail(self, response):
        ...
        try:
            # 众筹中
            if response.xpath(
                    '//div[@id="main_content"]/@class').extract()[0] == 'Campaign-state-live':
                ...
                if len(response.xpath(
                        'div[@class="project-image mb2 cf aspect-ratio--object"]/div')) > 0:
                ...
                item['des'] = response.xpath(
                    '//*[@id="content-wrap"]/section/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/span/span/text()').extract()[
                    0].strip()
                try:
                    item['organizer'] = response.xpath(
                        '//*[@id="content-wrap"]/section/div[2]/div[2]/div/div/div[2]/div[3]/div[2]/div[1]/div/div[2]/div[1]/a/text()').extract()[
                        0].strip()
                except BaseException:
                    item['organizer'] = response.xpath(
                        '//*[@id="content-wrap"]/section/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/div[1]/div/div[2]/div[1]/a/text()').extract()[
                        0].strip()

                if len(response.xpath(
                        '//*[@class="project-image mb2 cf aspect-ratio--object"]/div[@class="video-player"]')) > 0:
                    item['img_url'] = response.xpath(
                    ...
                    try:
                        ...
                        item['video_url'] = response.xpath(
                            '//*[@id="video_pitch"]/@data-video-url').extract()[0]
                else:
                    item['img_url'] = response.xpath(
                ...
                try:
                    item['raised_money'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div[2]/div[2]/div[1]/h3/span/text()').extract()[
                        0]
                    item['target_raise'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div[2]/div[2]/div[1]/div/span/text()').extract()[
                        0]
                    item['support_num'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div[2]/div[2]/div[2]/h3/text()').extract()[
                        0].strip()
                    item['type'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div[2]/div[1]/div/div/a[2]/text()').extract()[
                        0].strip()
                    item['address'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div[2]/div[1]/div/div/a[1]/text()').extract()[
                        0].strip()
                except BaseException:
                    item['raised_money'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div/div[2]/div[1]/h3/span/text()').extract()[
                        0]
                    item['target_raise'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div/div[2]/div[1]/div/span/text()').extract()[
                        0]
                    item['support_num'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div/div[2]/div[2]/h3/text()').extract()[
                        0]
                    item['type'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div/div[1]/div/div/a[2]/text()').extract()[
                        0].strip()
                    item['address'] = response.xpath(
                        '//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div/div[1]/div/div/a[1]/text()').extract()[
                        0].strip()
