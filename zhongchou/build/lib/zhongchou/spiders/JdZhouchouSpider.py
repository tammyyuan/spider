...
class JdZhouchouSpider(CrawlSpider):
    ...
    def parse_list(self, response):
        ...
        for p in range(2, max_page):
            ...
            yield FormRequest(url=url, formdata=formparams, headers=list_headers)
    ...
    def parse_detail(self, response):
        ...
        if status == 'zc-green-infinite':
            ...
            item['target_raise'] = symbol + response.xpath('//p[@class="p-target"]/span[2]/text()').extract()[0].strip()
